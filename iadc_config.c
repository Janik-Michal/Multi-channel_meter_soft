...
void initIADC(void)
{
    ...
    // wszystkie piny PC0..PC9 w tryb Disabled
    for (int p = 0; p < 10; p++) {
    ...
    // wypełnienie tabeli skanów PC9..PC0
    ...
    // przypisanie wszystkich szyn Portu C do ADC0
    GPIO->CDBUSALLOC =
